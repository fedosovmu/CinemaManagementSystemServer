...
namespace CinemaManagementSystemServer
{
    public class DatabaseManagement
    {
        ...
        SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\files\CinemaDatabase.mdf;Integrated Security=True;Connect Timeout=30");
